# -*- coding: utf-8 -*-
"""
Medical Report Analysis - FastAPI Backend
...
async def parse_document(file: UploadFile = File(...)):
    """Parse a medical document using TextIn official API. Returns markdown + pages."""
...
async def extract(req: ExtractRequest):
    """Call OpenAI-compatible LLM for medical report field extraction."""
